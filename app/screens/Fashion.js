    ...
    <View style={styles.container}>
      <View style={styles.topBar}>
        <View style={{ flexDirection: "row", alignItems: "baseline" }}>
          <Text style={{ color: "#fff", marginLeft: 20 }}>Fashion</Text>
        </View>
            ...
            {/* {productsData &&
              ...
              <View>
                ...
                <View>
                  ...
                  <ImageModal
                  resizeMode='contain'
                  source={require("../assets/brands/brand1.png")} 
                  //  style={styles.pics}
                  />
              ...
              <View>
                {/* image */}
                <View>
                  <Image source={require("../assets/brands/inkanga.png")} />
                </View>
                <View>
                {/* details */}
                <View>
          ...
          <View style={styles.brands}>
            <View>
              ...
              <View>
                {/* image */}
                <View>
                  <Image source={require("../assets/brands/inzuki.png")} 
            ...
            <View>
              ...
              <View>
                {/* image */}
                <View>
                  <Image source={require("../assets/brands/sandal.png")} />
                </View>
              </View>
              <View>
                {/* details */}
          ...
          <View style={styles.brands}>
            <View>
              ...
              <View>
                {/* image */}
                <View>
                  <Image source={require("../assets/brands/neckl.png")} 
            ...
            <View>
              ...
              <View>
                {/* image */}
                <View>
                  <Image source={require("../assets/brands/tshirt.png")} />
                </View>
              </View>
              <View>
                {/* details */}
