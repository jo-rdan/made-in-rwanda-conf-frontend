    ...
    <View style={styles.container}>
      <View style={styles.topBar}>
        <View style={{ flexDirection: "row", alignItems: "baseline" }}>
          <Text style={{ color: "#fff", marginLeft: 20 }}>Drinks</Text>
        </View>
        ...
        <View style={styles.categoriesCompo}>
          ...
          <View style={styles.categories}>
            ...
            <View>
              ...
              {/* texts */}
              <Text style={{ fontSize: 12, textAlign: "center", color: "red" }}>Drinks</Text>
            </View>
            <View>
              {/* icons */}
        ...
        <View style={styles.brands}>
          <View>
            <View>
              {/* image */}
              <View>
                <Image source={require("../assets/products/Nyirangarama.png")} />
              </View>
            </View>
            {/* details */}
            <View>
          ...
          <View >
            <View>
              {/* image */}
              <View>
                <Image source={require("../assets/products/GorillaCoffee.png")} />
              </View>
            </View>
            {/* details */}
            <View>
              ...
              <View>
                ...
                <View>
                  <Image
                    ...
                    source={require("../assets/products/GorillaCoffee.png")}
                  />
                </View>
              </View>
              <View>
